...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-[#1a1035] via-[#2a1850] to-[#1a1035] flex flex-col">
      {/* Header with logo */}
      ...
      <div className="p-6 pb-10">
        <Button 
          className="w-full py-6 text-lg font-semibold bg-white text-[#1a1035] hover:bg-white/90 rounded-full shadow-lg"
        >
          Log In
        </Button>
      </div>
